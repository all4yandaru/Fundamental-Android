package com.project.myjobscheduler
...
// TODO 1: New → Kotlin Class/Java Class, implements JobService
class GetCurrentWeatherJobService: JobService() {

    // TODO 3: lengkapi kodenya

    companion object{
        private val TAG = GetCurrentWeatherJobService::class.java.simpleName

        internal const val CITY = "Yogyakarta" // diisi dengan nama kota anda

        internal const val APP_ID = "0ae0c45389be3856855bc191e72a29c6" // diisi dengan key dari akun openweather
    }
        ...
        client.get(url, object : AsyncHttpResponseHandler(){
            override fun onSuccess(statusCode: Int, headers: Array<out Header>?, responseBody: ByteArray) {
                ...
                try {
                    ...
                    showNotication(applicationContext, title, message, notifId)
    ...
    private fun showNotication(context: Context, title: String, message: String, notifId: Int){
