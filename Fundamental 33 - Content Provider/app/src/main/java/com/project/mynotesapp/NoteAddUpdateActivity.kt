...
import com.project.mynotesapp.databinding.ActivityNoteAddUpdateBinding
...
class NoteAddUpdateActivity : AppCompatActivity(), View.OnClickListener {
    ...
    // TODO 8 Content Provider: ubah note jadi content provider
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // TODO 9 Content Provider : ini diganti
/*
...
*/
        ...
        if (isEdit) {
            // TODO 10 Content Provider : ini diganti
    ...
    override fun onClick(v: View?) {
        if (v?.id == R.id.btn_submit){
            ...
            if (isEdit) {
                ...
                // TODO 11 Content Provider : ubah jadi gini
                ...
                // TODO 12 Content Provider: ubah jadi gini
                values.put(DatabaseContract.NoteColumns.DATE, getCurrentDate())
                contentResolver?.insert(CONTENT_URI, values)
                Log.d("insertError", values.toString())
        ...
        alertDialogBuilder.setMessage(dialogMessage)
                ...
                .setPositiveButton("Ya") {_, _ ->
                    if (isDialogClose){
                        ...
                        // TODO 13 Content Provider: ubah jadi gini
